...
def join_node_etcd():
    ...
    if is_node_running_dqlite():
        msg = (
            ...
            "Please retry after enabling HA on this joining node with 'eks enable ha-cluster'."
        )
        error_msg = {"error": msg}
    ...
    subprocess.check_call("snapctl restart eks.daemon-apiserver".split())
...
def get_dqlite_voters():
    ...
    """
    snapdata_path = "/var/snap/eks/current"
